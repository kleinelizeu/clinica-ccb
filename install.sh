#!/usr/bin/env bash
# install.sh — Bootstrap do "Hermes Clínica by CCB".
# Uso (one-liner):
#   curl -fsSL https://raw.githubusercontent.com/kleinelizeu/clinica-ccb/main/install.sh | sudo bash
#
# Clona/atualiza o repositório, cria o comando global 'hermes-clinica' e abre o assistente.
...
PRODUTO="clinica-ccb"
PRODUTO_NOME="Hermes Clínica by CCB"
CLI_NAME="hermes-clinica"
REPO_URL="${PRODUTO_REPO:-https://github.com/kleinelizeu/clinica-ccb.git}"
